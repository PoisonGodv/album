...
{
    ui->setupUi(this);
    ui->previousBtn->SetIcons(":/new/icon/icon/previous.png",":/new/icon/icon/previous_hover.png",":/new/icon/icon/previous_press.png");

    ui->nextBtn->SetIcons(":/new/icon/icon/next.png",":/new/icon/icon/next_hover.png",":/new/icon/icon/next_press.png");
